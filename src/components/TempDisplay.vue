<template>
  <div class="hello">
    <div class="flex mb-4">
      <div class="w-full bg-gray-500 h-12">Hello</div>
    </div>
    <input
    ...
    />
    <div
      class="w-64 cursor-pointer border b-gray-400 rounded flex flex-col justify-center items-center text-center p-6 bg-white"
    >
...
export default {
  ...
  computed: mapGetters(['currentCityTemp']),
  created() {
